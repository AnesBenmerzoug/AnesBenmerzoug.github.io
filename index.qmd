...
I currently work as a Senior AI Engineer at [appliedAI Initiative](https://www.appliedai.de/) where I have worked on many different customer and internal projects.

When I'm not staffed on customer projects, I work on internal projects: I contributed to the [pyDVL](https://github.com/aai-institute/pyDVL) open-source library
and helped with the [TransferLab](https://transferlab.ai/authors/anes-benmerzoug)'s research projects
...
I hold a M.Sc. in Embedded Systems from the [Technical University of Kaiserslautern](https://www.uni-kl.de/en/home/) and a M.Sc. in Control and Automation from
...
* [ball-and-beam](https://github.com/AnesBenmerzoug/ball-and-beam)
  An open-source ball and beam control system with CAD design, simulation files, embedded firmware and web UI.

* [embedded-tfluna](https://github.com/AnesBenmerzoug/embedded-tfluna)
  An open-source platform-agnostic Rust driver for the TF-Luna LiDAR distance sensor.

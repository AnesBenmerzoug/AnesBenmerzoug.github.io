...
The reason turned out to be a mistake in the instruction manual (see @fig-instruction-manual-error). Unlike what's written in it, to **enable** (respectively **disable**) the lidar sensor you have to set the **0x25** register to **1** (respectively **0**) instead of **0** (respectively **1**). I will try to reach out to the manufacturer to inform them of this error, even though I doubt I am the first
person to stumble upon it.
